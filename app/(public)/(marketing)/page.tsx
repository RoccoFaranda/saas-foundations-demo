...
import { buildPublicPageMetadata, SITE_NAME } from "@/src/lib/seo/metadata";
...
export const metadata: Metadata = buildPublicPageMetadata({
  title: SITE_NAME,
  description:
    "Explore a production-style SaaS demo with guest mode, real auth flows, and a technical implementation walkthrough.",
  path: "/",
  absoluteTitle: true,
});
