...
export const metadata: Metadata = {
  title: "Cookie Declaration | SaaS Foundations Demo",
  description:
      ...
      <PageContainer className="space-y-6">
        <section className="rounded-2xl border border-border bg-surface p-6 sm:p-8">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground sm:text-base">
            This table lists active cookies and related storage technologies currently used in SaaS
            Foundations Demo.
          </p>
          ...
          {HAS_NON_ESSENTIAL_CONSENT_SERVICES ? (
            <p className="mt-4 rounded-lg border border-border bg-muted/45 px-3 py-2 text-sm text-muted-foreground">
              Optional technologies are currently active in this release and shown below with their
              disclosure metadata.
            </p>
          ) : (
            <p className="mt-4 rounded-lg border border-border bg-muted/45 px-3 py-2 text-sm text-muted-foreground">
              No optional categories are currently active in this release. The table still includes
              required technologies needed for core service operation.
            </p>
          )}
