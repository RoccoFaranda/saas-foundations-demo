...
export const metadata: Metadata = buildPublicPageMetadata({
  ...
  description:
    "Implementation notes covering what is real, what is simulated, and how auth, security, and testing are handled.",
  path: "/technical",
});
      ...
      <div className="py-16 sm:py-20">
        ...
        >
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground sm:text-base">
            This page will document what is real, what is simulated, and how auth, security
            controls, and testing are implemented in the demo.
          </p>
